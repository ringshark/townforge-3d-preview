...
var ASM_CONSTS = {
 ...
 116220: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116288: () => { document.exitFullscreen(); },  
 116315: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 116388: () => { if (document.fullscreenElement) return 1; },  
 116434: () => { return document.getElementById('canvas').width; },  
 116486: () => { return screen.width; },  
 116511: () => { document.exitFullscreen(); },  
 116538: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116671: () => { return window.innerWidth; },  
 116697: () => { return window.innerHeight; },  
 116724: () => { if (document.fullscreenElement) return 1; },  
 116770: () => { return document.getElementById('canvas').width; },  
 116822: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116890: () => { if (document.fullscreenElement) return 1; },  
 116936: () => { return document.getElementById('canvas').width; },  
 116988: () => { return screen.width; },  
 117013: () => { return window.innerWidth; },  
 117039: () => { return window.innerHeight; },  
 ...
 117189: () => { document.exitFullscreen(); },  
 ...
 117409: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117467: () => { return screen.width; },  
 117492: () => { return screen.height; },  
 117518: () => { return window.screenX; },  
 117545: () => { return window.screenY; },  
 117572: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117625: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117696: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117753: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 118009: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 118080: () => { if (document.fullscreenElement) return 1; },  
 118126: () => { return window.innerWidth; },  
 118152: () => { return window.innerHeight; },  
 118179: () => { if (document.pointerLockElement) return 1; }
};
