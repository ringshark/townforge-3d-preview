...
var ASM_CONSTS = {
  167842: () => { if (document.fullscreenElement) return 1; },  
 167888: () => { return document.getElementById('canvas').width; },  
 167940: () => { return parseInt(document.getElementById('canvas').style.width); },  
 168008: () => { document.exitFullscreen(); },  
 168035: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 168108: () => { if (document.fullscreenElement) return 1; },  
 168154: () => { return document.getElementById('canvas').width; },  
 168206: () => { return screen.width; },  
 168231: () => { document.exitFullscreen(); },  
 168258: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 168391: () => { return window.innerWidth; },  
 168417: () => { return window.innerHeight; },  
 168444: () => { if (document.fullscreenElement) return 1; },  
 168490: () => { return document.getElementById('canvas').width; },  
 168542: () => { return parseInt(document.getElementById('canvas').style.width); },  
 168610: () => { if (document.fullscreenElement) return 1; },  
 168656: () => { return document.getElementById('canvas').width; },  
 168708: () => { return screen.width; },  
 168733: () => { return window.innerWidth; },  
 168759: () => { return window.innerHeight; },  
 168786: () => { if (document.fullscreenElement) return 1; },  
 168832: () => { return document.getElementById('canvas').width; },  
 168884: () => { return screen.width; },  
 168909: () => { document.exitFullscreen(); },  
 168936: () => { if (document.fullscreenElement) return 1; },  
 168982: () => { return document.getElementById('canvas').width; },  
 169034: () => { return parseInt(document.getElementById('canvas').style.width); },  
 169102: () => { document.exitFullscreen(); },  
 169129: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 169187: () => { return screen.width; },  
 169212: () => { return screen.height; },  
 169238: () => { return window.screenX; },  
 169265: () => { return window.screenY; },  
 169292: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 169345: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 169416: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 169473: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 169729: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 169800: () => { if (document.fullscreenElement) return 1; },  
 169846: () => { return window.innerWidth; },  
 169872: () => { return window.innerHeight; },  
 169899: () => { if (document.pointerLockElement) return 1; }
};
