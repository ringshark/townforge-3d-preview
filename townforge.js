...
var ASM_CONSTS = {
  138594: () => { if (document.fullscreenElement) return 1; },  
 138640: () => { return document.getElementById('canvas').width; },  
 138692: () => { return parseInt(document.getElementById('canvas').style.width); },  
 138760: () => { document.exitFullscreen(); },  
 138787: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 138860: () => { if (document.fullscreenElement) return 1; },  
 138906: () => { return document.getElementById('canvas').width; },  
 138958: () => { return screen.width; },  
 138983: () => { document.exitFullscreen(); },  
 139010: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 139143: () => { return window.innerWidth; },  
 139169: () => { return window.innerHeight; },  
 139196: () => { if (document.fullscreenElement) return 1; },  
 139242: () => { return document.getElementById('canvas').width; },  
 139294: () => { return parseInt(document.getElementById('canvas').style.width); },  
 139362: () => { if (document.fullscreenElement) return 1; },  
 139408: () => { return document.getElementById('canvas').width; },  
 139460: () => { return screen.width; },  
 139485: () => { return window.innerWidth; },  
 139511: () => { return window.innerHeight; },  
 139538: () => { if (document.fullscreenElement) return 1; },  
 139584: () => { return document.getElementById('canvas').width; },  
 139636: () => { return screen.width; },  
 139661: () => { document.exitFullscreen(); },  
 139688: () => { if (document.fullscreenElement) return 1; },  
 139734: () => { return document.getElementById('canvas').width; },  
 139786: () => { return parseInt(document.getElementById('canvas').style.width); },  
 139854: () => { document.exitFullscreen(); },  
 139881: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 139939: () => { return screen.width; },  
 139964: () => { return screen.height; },  
 139990: () => { return window.screenX; },  
 140017: () => { return window.screenY; },  
 140044: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 140097: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 140168: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 140225: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 140481: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 140552: () => { if (document.fullscreenElement) return 1; },  
 140598: () => { return window.innerWidth; },  
 140624: () => { return window.innerHeight; },  
 140651: () => { if (document.pointerLockElement) return 1; },  
 140698: ($0, $1, $2, $3, $4) => { if (typeof window === 'undefined' || (window.AudioContext || window.webkitAudioContext) === undefined) { return 0; } if (typeof(window.miniaudio) === 'undefined') { window.miniaudio = { referenceCount: 0 }; window.miniaudio.device_type = {}; window.miniaudio.device_type.playback = $0; window.miniaudio.device_type.capture = $1; window.miniaudio.device_type.duplex = $2; window.miniaudio.device_state = {}; window.miniaudio.device_state.stopped = $3; window.miniaudio.device_state.started = $4; miniaudio.devices = []; miniaudio.track_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == null) { miniaudio.devices[iDevice] = device; return iDevice; } } miniaudio.devices.push(device); return miniaudio.devices.length - 1; }; miniaudio.untrack_device_by_index = function(deviceIndex) { miniaudio.devices[deviceIndex] = null; while (miniaudio.devices.length > 0) { if (miniaudio.devices[miniaudio.devices.length-1] == null) { miniaudio.devices.pop(); } else { break; } } }; miniaudio.untrack_device = function(device) { for (var iDevice = 0; iDevice < miniaudio.devices.length; ++iDevice) { if (miniaudio.devices[iDevice] == device) { return miniaudio.untrack_device_by_index(iDevice); } } }; miniaudio.get_device_by_index = function(deviceIndex) { return miniaudio.devices[deviceIndex]; }; miniaudio.unlock_event_types = (function(){ return ['touchend', 'click']; })(); miniaudio.unlock = function() { for(var i = 0; i < miniaudio.devices.length; ++i) { var device = miniaudio.devices[i]; if (device != null && device.webaudio != null && device.state === window.miniaudio.device_state.started) { device.webaudio.resume().then(() => { Module._ma_device__on_notification_unlocked(device.pDevice); }, (error) => {console.error("Failed to resume audiocontext", error); }); } } miniaudio.unlock_event_types.map(function(event_type) { document.removeEventListener(event_type, miniaudio.unlock, true); }); }; miniaudio.unlock_event_types.map(function(event_type) { document.addEventListener(event_type, miniaudio.unlock, true); }); } window.miniaudio.referenceCount += 1; return 1; },  
 142856: () => { if (typeof(window.miniaudio) !== 'undefined') { window.miniaudio.referenceCount -= 1; if (window.miniaudio.referenceCount === 0) { delete window.miniaudio; } } },  
 143020: () => { return (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined); },  
 143124: () => { try { var temp = new (window.AudioContext || window.webkitAudioContext)(); var sampleRate = temp.sampleRate; temp.close(); return sampleRate; } catch(e) { return 0; } },  
 ...
 146123: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 146189: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 146582: ($0) => { miniaudio.untrack_device_by_index($0); },  
 146625: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 146750: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
