...
// include: C:\Users\markr\AppData\Local\Temp\tmp8i31chts.js
...
var ASM_CONSTS = {
  116074: () => { if (document.fullscreenElement) return 1; },  
 116120: () => { return document.getElementById('canvas').width; },  
 116172: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116240: () => { document.exitFullscreen(); },  
 116267: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 116340: () => { if (document.fullscreenElement) return 1; },  
 116386: () => { return document.getElementById('canvas').width; },  
 116438: () => { return screen.width; },  
 116463: () => { document.exitFullscreen(); },  
 116490: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116623: () => { return window.innerWidth; },  
 116649: () => { return window.innerHeight; },  
 116676: () => { if (document.fullscreenElement) return 1; },  
 116722: () => { return document.getElementById('canvas').width; },  
 116774: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116842: () => { if (document.fullscreenElement) return 1; },  
 116888: () => { return document.getElementById('canvas').width; },  
 116940: () => { return screen.width; },  
 116965: () => { return window.innerWidth; },  
 116991: () => { return window.innerHeight; },  
 117018: () => { if (document.fullscreenElement) return 1; },  
 117064: () => { return document.getElementById('canvas').width; },  
 117116: () => { return screen.width; },  
 117141: () => { document.exitFullscreen(); },  
 117168: () => { if (document.fullscreenElement) return 1; },  
 117214: () => { return document.getElementById('canvas').width; },  
 117266: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117334: () => { document.exitFullscreen(); },  
 117361: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117419: () => { return screen.width; },  
 117444: () => { return screen.height; },  
 117470: () => { return window.screenX; },  
 117497: () => { return window.screenY; },  
 117524: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117577: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117648: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117705: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 117961: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 118032: () => { if (document.fullscreenElement) return 1; },  
 118078: () => { return window.innerWidth; },  
 118104: () => { return window.innerHeight; },  
 118131: () => { if (document.pointerLockElement) return 1; }
};
