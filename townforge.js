...
var ASM_CONSTS = {
  163304: () => { if (document.fullscreenElement) return 1; },  
 163350: () => { return Module.canvas.width; },  
 163382: () => { return parseInt(Module.canvas.style.width); },  
 163430: () => { document.exitFullscreen(); },  
 163457: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 163529: () => { if (document.fullscreenElement) return 1; },  
 163575: () => { return Module.canvas.width; },  
 163607: () => { return screen.width; },  
 163632: () => { document.exitFullscreen(); },  
 163659: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 163853: () => { return window.innerWidth; },  
 163879: () => { return window.innerHeight; },  
 163906: () => { if (document.fullscreenElement) return 1; },  
 163952: () => { return Module.canvas.width; },  
 163984: () => { return parseInt(Module.canvas.style.width); },  
 164032: () => { if (document.fullscreenElement) return 1; },  
 164078: () => { return Module.canvas.width; },  
 164110: () => { return screen.width; },  
 164135: () => { return window.innerWidth; },  
 164161: () => { return window.innerHeight; },  
 164188: () => { if (document.fullscreenElement) return 1; },  
 164234: () => { return Module.canvas.width; },  
 164266: () => { return screen.width; },  
 164291: () => { document.exitFullscreen(); },  
