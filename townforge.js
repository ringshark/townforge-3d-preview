...
var ASM_CONSTS = {
  168368: () => { if (document.fullscreenElement) return 1; },  
 168414: () => { return Module.canvas.width; },  
 168446: () => { return parseInt(Module.canvas.style.width); },  
 168494: () => { document.exitFullscreen(); },  
 168521: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 168593: () => { if (document.fullscreenElement) return 1; },  
 168639: () => { return Module.canvas.width; },  
 168671: () => { return screen.width; },  
 168696: () => { document.exitFullscreen(); },  
 168723: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 168917: () => { return window.innerWidth; },  
 168943: () => { return window.innerHeight; },  
 168970: () => { if (document.fullscreenElement) return 1; },  
 169016: () => { return Module.canvas.width; },  
 169048: () => { return parseInt(Module.canvas.style.width); },  
 169096: () => { if (document.fullscreenElement) return 1; },  
 169142: () => { return Module.canvas.width; },  
 169174: () => { return screen.width; },  
 169199: () => { return window.innerWidth; },  
 169225: () => { return window.innerHeight; },  
 169252: () => { if (document.fullscreenElement) return 1; },  
 169298: () => { return Module.canvas.width; },  
 169330: () => { return screen.width; },  
 169355: () => { document.exitFullscreen(); },  
 169382: () => { if (document.fullscreenElement) return 1; },  
 169428: () => { return Module.canvas.width; },  
 169460: () => { return parseInt(Module.canvas.style.width); },  
 169508: () => { document.exitFullscreen(); },  
 169535: ($0) => { Module.canvas.style.opacity = $0; },  
 169573: () => { return screen.width; },  
 169598: () => { return screen.height; },  
 169624: () => { return window.screenX; },  
 169651: () => { return window.screenY; },  
 169678: () => { return window.devicePixelRatio; },  
 169714: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 169767: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 169818: () => { Module.canvas.style.cursor = 'none'; },  
 169855: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 170111: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 170162: () => { if (document.pointerLockElement) return 1; },  
 170209: () => { if (document.fullscreenElement) return 1; },  
 170255: () => { return window.innerWidth; },  
 170281: () => { return window.innerHeight; },  
